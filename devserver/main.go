...
var (
	...
	index_html      = flag.String("index_html", "index.html", "index of devserver")
)
...
func main() {
	...
	http.HandleFunc("/", devserver.CreateFileHandler(*servingPath, *manifest, pkgList, *base, *index_html))
